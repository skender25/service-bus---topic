...
namespace topic_send
{
    class Program
    {
        private static string _bus_connectionstring = "Endpoint=sb://prueba456.servicebus.windows.net/;SharedAccessKeyName=app;SharedAccessKey=U7P8fXhVuw/L2AuIIAjfqQWpkWBpXgbDAUD5cKipjZc=";
        private static string _topic_name = "topicdemo";
